<template>
  ...
  <div class="container">
    ...
    <div class="my-3 text-white">Menampilkan {} Dari {} Peminjam</div>
    <table>
        <thead>
            <tr class="bgrcolor">
                <th>No</th>
...
#searchInput {
  padding: 5px 5px 5px 30px; /* Tambahkan padding kiri untuk memberi ruang pada ikon */
